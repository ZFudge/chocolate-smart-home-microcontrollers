...
testF(PIR_transform_no_twinkle, on_off) {
    ...
    assertTrue(0 == test_controller.pir->lastMotionDetected);
    ...
    const int secondsLapsedSinceLastReading = (millis() - test_controller.pir->lastMotionDetected) / 1000;
    assertMore(secondsLapsedSinceLastReading, test_controller.pir->timeoutInSeconds);
